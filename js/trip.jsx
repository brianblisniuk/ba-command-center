...
(function () {
  ...
  const TABS = ['Resumen', 'Accesos', 'Itinerario', 'Ruta', 'Proveedores', 'Cupos', 'Pulso', 'Presupuesto', 'Reservas', 'Tareas', 'App cliente', 'Backup', 'Config'];
  ...
  function Trip({ tripId, cur, toast, back, tab, setTab, openLead, openProvider, op }) {
    ...
    return React.createElement('div', { className: 'content-inner' },
      ...
      (needsData && !ready) ? loadingCard
        ...
        : tab === 'Proveedores' ? React.createElement(window.Proveedores, { s, cur, toast, openProvider })
        : tab === 'Cupos' ? React.createElement(window.Cupos, { s, cur, toast, openLead })
        : tab === 'Pulso' ? React.createElement(window.Pulso, { s, cur, toast, openLead })
        : tab === 'Presupuesto' ? React.createElement(window.Presupuesto, { s, cur, toast })
        : tab === 'Reservas' ? React.createElement(window.Reservas, { s, cur, toast, openLead })
        : tab === 'Tareas' ? React.createElement(window.Tareas, { s, toast, openProvider, op })
        : tab === 'App cliente' ? React.createElement(window.AppCliente, { s, toast })
        : tab === 'Backup' ? React.createElement(window.Backup, { s, toast })
