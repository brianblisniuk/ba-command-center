        ...
        React.createElement('div', { className: 'card pad' },
          ...
          grupos.length === 0
            ...
            : grupos.map(g => React.createElement('div', { key: g.key, style: { marginBottom: 14 } },
              ...
              g.items.map(p => React.createElement('div', { key: p.id, style: { display: 'flex', alignItems: 'center', gap: 10, padding: '8px 10px', background: 'var(--surface-2)', borderRadius: 'var(--radius-sm)', marginBottom: 6 } },
